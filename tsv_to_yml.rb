...
# Refactoring 1. Use begin..end transaction on processing steps 2.Use Named constants instead of having "magic constants"
require 'yaml'
require 'csv'
...
def load_tsv(in_tsv_file)
  tsv_data = []
  tsv_file = CSV.open(in_tsv_file, 'r', **{ col_sep: TAB })
